...
(function () {
    ...
    const CHEAT_CODES = [
        ...
        },
        {
            ...
            meaning: 'The cicada sings at full volume with no knowledge of its own mortality. Its cry is complete and self-contained — not tragic, not defiant, just alive. Bashō finds in this a quiet instruction: live so fully in the present that death has nothing to interrupt. This is *mono no aware* (物の哀れ) — the bittersweet awareness that all things pass, and that this passing is the source of their beauty, not their diminishment.',
            funResponse: (word) =>
        ...
        },
        {
            ...
            meaning: 'The bell-sound is fleeting; the blossom-scent lingers. Bashō weaves two senses — hearing and smell — into a meditation on what endures and what does not. The evening is perfect not in spite of loss but because of it. *Wabi-sabi* (侘寂): the beauty found in imperfection, impermanence, and incompleteness. The last peal of the bell makes the remaining silence more fragrant.',
            funResponse: (word) =>
        ...
        },
        {
            ...
            meaning: 'Buson was a painter before he was a poet, and this haiku is pure visual thinking. The lightning reveals — and misleads. For one instant the darkness seemed to hold human faces; the next instant only grass. Buson captures the way the mind reaches for meaning in the void and projects what it most fears or desires. The haiku asks: what else do we see that is only pampas grass?',
            funResponse: (word) =>
        ...
        },
        {
            ...
            meaning: 'Written as Bashō lay dying in Osaka at 51. He spent his life travelling — literal journeys gave him his greatest poems. Now, body-broken and fevered, his dreams still walk. The withered field is both the late-autumn landscape and his own failing body, both literal and metaphor without effort. He dies as he lived: wandering, noticing, writing. His last poem is not farewell — it is one more step on the road.',
            funResponse: (word) =>
