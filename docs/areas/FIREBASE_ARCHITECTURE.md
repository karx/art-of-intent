---
published: false
title: "Firebase Architecture (STALE)"
tags:
  - firebase
  - architecture
description: "STALE — written for the old vanilla JS era. References dead collections (leaderboards, dailyChallenges). Superseded by data-model.md and FIREBASE_FUNCTIONS_ARCHITECTURE.md."
date: 2026-04-25
layer: L2-System
maturity: STUB
para: Crystallized
